...
//    Home page hwere user draws numbers, and clicks on an operation

// once user clicks submit in home page, will direct to results page

// request to backend, does computation, gives it back to frontend

// get request for results page

// pass it as a prop to results page
// dirrectn lagnuages, rescript, ocaml
// need to call backend server /compute to perform computation

// post request
// request json is {input_num, input_num, operation}

// Results page where result number is displayed
