...
let () = printf "\nNeural Network predicts: %i \n" (predictImageFromFileName "handwrittenImage.txt" "/mnt/c/Users/Rawstone/OneDrive/Dokumenter/Skole/Universitet/5Semester/FunctionalProgramming/FPSE-FinalProject/src/weights")  (*ExampleTest *)
